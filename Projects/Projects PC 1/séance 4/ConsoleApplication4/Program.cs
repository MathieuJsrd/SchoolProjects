...
namespace ConsoleApplication10
{
    class Program
    {
        ...
        static int NombreDejoursAnneeInt(int moisInt, int anneeInt)
        {
            ...
            {
                Console.WriteLine("*** ERREUR001 DANS FONCTION NombreDejoursAnneeInt : mois incorrect moisInt:" + moisInt);
                return returnedNbreDeJoursInt;
            }
            if (anneeInt < 0 || anneeInt > 3000)
            {
                Console.WriteLine("*** ERREUR002 DANS FONCTION NombreDejoursAnneeInt : annee incorrecte anneeInt:" + anneeInt);
                return returnedNbreDeJoursInt;
            }
        ...
        public static void Exercice4()
        {
            ...
            while (valeurSaisieInt != 9)
            {
                ...
                // Controle de la réponse de l'utilisateur
                ...
                // on sait que la réponse est un int
                ...
                if (reponseStr != "9")
                {
                    ...
                    //Début de l'excécution des différentes fonctions écrites précedemment
                    ...
                    else if (valeurSaisieInt == 8)
                    {
                        for (int i = anneeInt; i < anneeInt + 11; i++)
                        {
                            // on lance l'algo avec retour dans tableau où indice 0 = paques, indice 1 = samediSaint, indice 2 = mardi gras
                            // indice 3 = ascension, indice 4 = pentecôte, indice 5 = toussaint
                ...
                //sortie du if (valeurSaisie != 9)
            }
            //sortie du while (valeurSaisieInt != 9)
        }
        #endregion
        ...
        {
            //Console.WriteLine(AlgoFetesMobilesChretiennesStr(2016));
            Exercice4();
            Console.ReadKey();
        }
    }
